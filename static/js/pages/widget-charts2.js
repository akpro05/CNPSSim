...
//Project:	Caisse Nationale De Prevoyance SocialeResponsive Admin Template
...
$( document ).ready(function() {
	...
	if( $('#chart_1').length > 0 ){
		...
		var data1 = {
			...
			{
				label: "fir",
				backgroundColor: "rgba(254, 193, 7, 0.6)",
				borderColor: "rgba(254, 193, 7, 0.6)",
				pointBorderColor: "rgba(254, 193, 7, 0.6)",
				pointHighlightStroke: "rgba(254, 193, 7, 0.6)",
			...
			},
			{
				...
				pointBorderColor: "rgba(0, 194, 146, 0.6)",
				pointBackgroundColor: "rgba(0, 194, 146, 0.6)",
	...
	if( $('#chart_3').length > 0 ){
		...
		var data3 = {
			...
			datasets: [
				...
				{
					label: "My Second dataset",
					backgroundColor: "rgba(57, 139, 247, 0.6)",
					borderColor: "rgba(57, 139, 247, 0.6)",
					pointBackgroundColor: "rgba(57, 139, 247, 0.6)",
					pointBorderColor: "#fff",
					pointHoverBackgroundColor: "#fff",
					pointHoverBorderColor: "rgba(57, 139, 247, 0.6)",
			...
			datasets: [
				{
					...
					backgroundColor:"rgba(3, 169, 243, 0.6)",
					hoverBackgroundColor: "rgba(3, 169, 243, 0.6)",
				},
				{
					...
					backgroundColor:"rgba(254, 193, 7, 0.6)",
					hoverBackgroundColor: "rgba(254, 193, 7, 0.6)",
				}]
		};
	...
	if( $('#transactionDetails').length > 0 ){
		var txn = document.getElementById("transactionDetails").getContext("2d");
		var data6 = {
			 labels: [
			"Approved",
			"Declained" 
